...
![The Top 10 Features of Used by  XGBoost Model Training ](./images/feature_importance.png){#fig-importance width=100%}
...
![SHAP Summary: Top 10 Feature Effects](./images/shap_summary_graph.png){#fig-shap width=100%}
